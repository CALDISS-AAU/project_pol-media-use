...
def get_article_info(link, keywords, source_url = "https://www.dr.dk/nyheder/politik"):
    '''
...
def headline_watch(keywords, datadir, source_url = "https://www.dr.dk/nyheder/politik/"):
    '''
